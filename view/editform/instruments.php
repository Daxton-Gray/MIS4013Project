...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editInstrumentModal<? echo $instrument['instrument_id']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="editInstrumentModal<? echo $instrument['instrument_id']; ?>" tabindex="-1" aria-labelledby="editInstrumentModalLabel<? echo $instrument['instrument_id']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editInstrumentModalLabel<? echo $instrument['instrument_id']; ?>">Edit Instrument</h1>
...
include "view/input-list/categories.php";
?>
          </div>
          <div class="mb-3">
