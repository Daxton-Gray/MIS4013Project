...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editInventoryModal<? echo $inventory['inventory_id']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="editInventoryModal<? echo $inventory['inventory_id']; ?>" tabindex="-1" aria-labelledby="editInventoryModalLabel<? echo $inventory['inventory_id']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editInventoryModalLabel<? echo $inventory['inventory_id']; ?>">Edit Inventory</h1>
...
?>
          ...
          <div class="mb-3">
            <label for="inst_id<? echo $inventory['inventory_id']; ?>" class="form-label">Instrument</label>
<?php
$instrumentList = selectInstrumentsForInput();
$selectedInstrument = $inventory['instrument_id'];
...
?>
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="stock_quantity<? echo $inventory['inventory_id']; ?>" name="stock_quantity" value="<? echo $inventory['stock_quantity']; ?>" step="0.01" required>
          </div>
