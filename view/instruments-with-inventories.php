...
?>
    <li class="list-group-item"><?php echo $inventory['brand_name']; ?> <?php echo $inventory['instrument name']; ?> - <?php echo $inventory['model']; ?> - <?php echo $inventory['price']; ?> Seasons - <?php echo $inventory['stock_quantity']; ?> MVPs</li>
<?php
  }
?>
      </ul>
