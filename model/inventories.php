    ...
    try
      {
        ...
        $stmt = $conn->prepare("SELECT * FROM inventory IV JOIN Instrument I ON I.instrument_id=IV.instrument_id JOIN brand B ON B.brand_id=IV.brand_id ORDER BY instrument_name, brand_name, model");
        $stmt->execute();
